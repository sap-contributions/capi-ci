...
This pipeline is responsible for testing, building, and releasing capi-release. For guideance on releasing CAPI, see [this document](https://github.com/cloudfoundry/capi-release/blob/develop/docs/releasing-capi.md).
